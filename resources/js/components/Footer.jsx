...
export default function Footer(props) {
    return (
        <footer className="footer items-center p-4 bg-base-200 text-base">
            ...
            <div className="hidden md:grid md:grid-flow-col md:gap-4 md:place-self-center md:justify-self-end">
