    ...
    render() {
        return (
            <div title="Change Theme" className="dropdown dropdown-start">
                ...
                <div className="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96 h-[70vh] -left-10 md:left-0 w-52 overflow-y-auto shadow-2xl mt-16">
