...
export default function NavBar(props) {
    ...
    return (
        <>
            <div className="absolute top-0 left-0 z-40 navbar bg-neutral text-neutral-content overflow-x-clip p-0 pr-4 sm:pr-0">
                <div className="flex-1 justify-center">
                    <h3 className="font-mono text-center text-lg sm:text-xl">cardsagainst.xyz</h3>
                </div>
            </div>
            <div className="absolute top-0 left-0 z-40 navbar bg-transparent text-neutral-content overflow-x-clip p-0">
